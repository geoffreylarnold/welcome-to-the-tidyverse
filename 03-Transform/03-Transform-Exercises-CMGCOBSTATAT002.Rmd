...
```{r}
setwd("C:/Users/T111196/OneDrive - Allegheny County/Documents/GitHub/welcome-to-the-tidyverse/03-Transform")
...
```{r}
filter(babynames, n>=0.08, year == 1880)
...
```{r}
filter(babynames, name == "Sue")
filter(babynames, n==5|n==6, year == 1880)
filter(babynames, name == "Acure"|name == "Lexus"|name =="Yugo")
```
...
arrange(babynames, n, prop)  #acending is default#
```
...
# cumulative_sum, cumulative_max...#
# mutate (percent = round (prop*100, 2)), nper = round(percnet)#
